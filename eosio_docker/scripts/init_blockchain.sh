...
# Active key for sally
cleos wallet import -n notechainwal --private-key 5KFyaxQW8L6uXFB6wSgC44EsAbzC7ideyhhQ68tiYfdKQp69xKo

# config key for daniel
...
cleos wallet import -n notechainwal --private-key 5KXKxwkmvFHffqLVMcopKvJiGArQLUtZfZj5LV43Un3yX2t5kMQ

# chestnut key for daniel
...
cleos wallet import -n notechainwal --private-key 5JjnmnZba51EemGQudn5n9v791mfaPnSvQHiXyGei9kiiEtrMGi
...
cleos system newaccount eosio --transfer chestnutacnt EOS8BCgapgYA2L4LJfCzekzeSr3rzgSTUXRXwNi8bNRoz31D14en9 \
--stake-net "1.0000 EOS" --stake-cpu "1.0000 EOS" --buy-ram-kbytes 138675


echo "=== give eosio.code permission to chestnutacnt ==="
cleos set account permission chestnutacnt active \
'{"threshold": 1,"keys": [{"key": "EOS8BCgapgYA2L4LJfCzekzeSr3rzgSTUXRXwNi8bNRoz31D14en9","weight": 1}],"accounts": [{"permission":{"actor":"chestnutacnt","permission":"eosio.code"},"weight":1}]}' \
owner -p chestnutacnt
...
deploy_contract.sh chestnutacnt chestnutacnt notechainwal $(cat notechain_wallet_password.txt)
